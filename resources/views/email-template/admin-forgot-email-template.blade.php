<p>Dear {{ $admin->name }}</p>
<p>
    We are received a request to reset the password for Starcom account associated with {{ $admin->email }}. You can reset your password by clicking the button below:
    <br>
